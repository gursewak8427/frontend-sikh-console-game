...
import AuthScreen from "../Screens/Authentication/UserAuthScreen";
...
const UserLogin = (props) => {
    ...
    const LoginNow = async () => {
        ...
        const data2 = { username: data, password }
        const config = { 'content-type': 'application/json' }
        axios.post(process.env.REACT_APP_NODE_URL + "/user/login", data2).then(res => {
            console.log(res)
            ...
            authenticate(res, "user", () => {
                // alert(res.data.message)
                console.log("Token added as user_token")
                window.location.href = "/d/user/"
            })

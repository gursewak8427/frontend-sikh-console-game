...
(function (Convertor) {
  function convertStringUsingMapper(mapperConfig, stringToConvert) {
    var mapper = mapperConfig.mapper,
      maxWidth = mapperConfig.maxWidth,
      moveRightChars = mapperConfig.moveRightChars,
      moveLeftChars = mapperConfig.moveLeftChars,
      moveAcrossCharacters = mapperConfig.moveAcrossCharacters;
    var output = [];
  ...
  function insertCharOnLeft(
    ...
    if (lastChar) {
      if (moveLeftAcrossChars.indexOf(lastChar) > -1) {
        ...
        chars.push.apply(
          chars,
          [characterToAdd, lastChar].concat(onRightChars)
        );
      }
    } else {
  ...
  function getMapper(to, from, compositions, moveAcrossCharSet) {
    var mappingLength = Math.max(
      to.characterCodes.length,
      from.characterCodes.length
    );
    var mapper = {};
    ...
    var maxWidth = 1;
    for (
      var _i = 0, compositions_1 = compositions;
      _i < compositions_1.length;
      _i++
    ) {
      var compositionCharArrays = compositions_1[_i];
      var toCharacter = getCompositionCharacters(
        compositionCharArrays,
        to.characterCodes
      )[0];
      if (toCharacter) {
        var fromCharacters = getCompositionCharacters(
          compositionCharArrays,
          from.characterCodes
        );
        for (
          var _a = 0, fromCharacters_1 = fromCharacters;
          _a < fromCharacters_1.length;
          _a++
        ) {
    ...
    var moveLeftCharIndexes = from.moveRightCharacters.filter(function (a) {
      return to.moveRightCharacters.indexOf(a) === -1;
    });
    var moveRightCharIndexes = to.moveRightCharacters.filter(function (a) {
      return from.moveRightCharacters.indexOf(a) === -1;
    });
    var moveAcrossCharacters = moveAcrossCharSet
      .map(function (a) {
        return getCompositionCharacters(a, to.characterCodes);
      })
      .reduce(function (a, b) {
        return a.concat(b);
      }, []);
    return {
      mapper: mapper,
      maxWidth: maxWidth,
      moveLeftChars: moveLeftCharIndexes.map(function (c) {
        return getCharFromUnicode(to.characterCodes[c]);
      }),
      moveAcrossCharacters: moveAcrossCharacters,
      moveRightChars: moveRightCharIndexes.map(function (c) {
        return getCharFromUnicode(to.characterCodes[c]);
      }),
    };
  }
  ...
  function getCompositionCharacters(compositionCharArrays, codes) {
    var characters = [];
    for (
      var _i = 0, compositionCharArrays_1 = compositionCharArrays;
      _i < compositionCharArrays_1.length;
      _i++
    ) {
      ...
      var charCodes = [];
      for (
        var _a = 0, compositionChar_1 = compositionChar;
        _a < compositionChar_1.length;
        _a++
      ) {
...
(function (PunjabiFontConvertor) {
  PunjabiFontConvertor.anmolMapping =
    ((_a = {}),
...
var PunjabiFontConvertor;
(function (PunjabiFontConvertor) {
  PunjabiFontConvertor.unicodeMapping =
    ((_a = {}),
...
var PunjabiFontConvertor;
(function (PunjabiFontConvertor) {
  PunjabiFontConvertor.drChatrikMappings =
    ((_a = {}),
...
var PunjabiFontConvertor;
(function (PunjabiFontConvertor) {
  PunjabiFontConvertor.awazeMappings =
    ((_a = {}),
...
var PunjabiFontConvertor;
(function (PunjabiFontConvertor) {
  PunjabiFontConvertor.gurbaniLipi =
    ((_a = {}),
    (_a[126 /* GZero */] = 0x30),
    (_a[127 /* GOne */] = 0x31),
    (_a[129 /* GTwo */] = 0x32),
...
(function (PunjabiFontConvertor) {
  var moveAcrossChaSet = [
    ...
    [
      [76 /* PairiYaiya */],
      [118 /* Virama */, 52 /* Yà¨¯ */, 118 /* Virama */, 52 /* Yà¨¯ */],
    ],
    [[77 /* PairiTata */], [118 /* Virama */, 42 /* Tà¨¤ */]],
    [[78 /* PairiNana */], [118 /* Virama */, 46 /* Nà¨¨ */]],
    [
      [71 /* PairiRaraPairiBindi */],
      [69 /* PairiRara */, 63 /* PairiBindi */],
      [69 /* PairiRara */, 64 /* PairiBindi2 */],
      [63 /* PairiBindi */, 118 /* Virama */, 53 /* Rà¨° */],
      [64 /* PairiBindi2 */, 118 /* Virama */, 53 /* Rà¨° */],
    ],
  ];
  var ikOnkarVersion1 = [
    [0 /* IkOnkarVersion1 */],
    [1 /* IkOnkarVersion1a */, 2 /* IkOnkarVersion1b */],
    [1 /* IkOnkarVersion1a */],
    [127 /* GOne */, 9 /* Onkar1 */],
  ];
  var ikOnkarVersion2 = [
    [3 /* IkOnkarVersion2 */],
    [4 /* IkOnkarVersion2a */, 5 /* IkOnkarVersion2b */],
    [4 /* IkOnkarVersion2a */],
    [127 /* GOne */, 10 /* Onkar2 */],
  ];
  ...
  var compositions = moveAcrossChaSet.concat([
    ...
    [
      [147 /* Nu */],
      [46 /* Nà¨¨ */, 106 /* Dulainkar */, 82 /* Tippi */],
      [46 /* Nà¨¨ */, 82 /* Tippi */, 106 /* Dulainkar */],
      [148 /* NanaDulainkar */, 82 /* Tippi */],
    ],
    ...
    [
      [68 /* PairiHahaDulainkar */],
      [118 /* Virama */, 26 /* Hà¨¹ */, 106 /* Dulainkar */],
    ],
    [
      [101 /* BihariBindi */],
      [102 /* BihariBindi2 */],
      [99 /* Bihari */, 85 /* Bindi */],
      [100 /* Bihari2 */, 85 /* Bindi */],
    ],
    [[113 /* Hora */], [114 /* Hora2 */]],
    ...
    [
      [179 /* KakaPairiRara */],
      [27 /* Kà¨• */, 69 /* PairiRara */],
      [27 /* Kà¨• */, 118 /* Virama */, 53 /* Rà¨° */],
    ],
    [[12 /* Uà¨‰ */], [11 /* Uà©³ */, 103 /* Aunkar */]],
    [
      [180 /* LalaDulainkar */],
      [54 /* Là¨² */, 106 /* Dulainkar */],
      [54 /* Là¨² */, 107 /* Dulainkar2 */],
    ],
    [
      [181 /* LalaAunkar */],
      [54 /* Là¨² */, 103 /* Aunkar */],
  ...
  function convert(str, toFontName, fromFontName) {
    ...
    var mapperConfig = Convertor.getMapper(
      to,
      from,
      compositions,
      moveAcrossChaSet
    ...
    mapperConfig.mapper["Æ"] = ">"; // IkOnkarLeft part
    mapperConfig.mapper["Å"] = "<"; // right part
